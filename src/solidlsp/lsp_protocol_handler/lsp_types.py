# The code in this module is mostly autogenerated using https://github.com/predragnikolic/OLSP
# To update it for higher LSP versions, autogenerate a new version in a different file and merge manually.

# LSP v3.17.0
# Note by author of the autogenerator: Look into use of https://pypi.org/project/ts2python/ to generate the types f
#  or https://microsoft.github.io/language-server-protocol/specifications/lsp/3.17/specification/
...
class SymbolKind(IntEnum):
    ...
    Unknown = 0
    """Not an LSP type, we use it to represent symbols that don't have a known kind."""
    File = 1
    Module = 2
    Namespace = 3
    Package = 4
